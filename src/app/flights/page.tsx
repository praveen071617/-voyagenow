      ...
      segments: [
        {
          from,
          to: hub.code,
          departure: `${String(5 + Math.floor(Math.random() * 8)).padStart(2, "0")}:${["00", "15", "30", "45"][Math.floor(Math.random() * 4)]}`,
          arrival: `${String(10 + Math.floor(Math.random() * 8)).padStart(2, "0")}:${["00", "15", "30", "45"][Math.floor(Math.random() * 4)]}`,
          duration: `${4 + Math.floor(Math.random() * 3)}h ${Math.floor(Math.random() * 4) * 15}m`,
          aircraft: ["320", "321", "32N", "789", "77W", "359"][Math.floor(Math.random() * 6)],
        },
        {
          from: hub.code,
          to,
          departure: `${String(14 + Math.floor(Math.random() * 6)).padStart(2, "0")}:${["00", "15", "30", "45"][Math.floor(Math.random() * 4)]}`,
          arrival: `${String(18 + Math.floor(Math.random() * 4)).padStart(2, "0")}:${["00", "15", "30", "45"][Math.floor(Math.random() * 4)]}`,
          duration: `${1 + Math.floor(Math.random() * 3)}h ${Math.floor(Math.random() * 4) * 15}m`,
